...
export default function LandingPage() {
    ...
    return (
        <div className="h-screen bg-hero-pattern bg-cover bg-bottom fixed top-0 left-0 right-0">
            ...
            h-3/5 lg:h-auto 2xl:h-1/2" /*style={{ fontFamily: "system-ui, sans-serif", lineHeight: "1.8" }}*/>
                ...
                <div className="grid place-items-center text-center">
                    <h3 className="text-sm md:text-lg lg:text-lg xl:text-xl 2xl:text-2xl">Plan your dream day. Create an event, guest list, budget.
